...
<head>
    ...
    <title>Super Admin - Administrator Management</title>
    ...
    <div class="main-content">
        ...
        <div class="stats-container">
            <div class="stat-card" style="animation-delay: 0.1s;">
                ...
                <div class="stat-value"><?php echo count($admin_list); ?></div>
        ...
        <div class="controls-section">
            <div class="search-container">
                ...
                <form method="GET" action="" style="display: flex; align-items: center;">
                    <input type="text" name="search" class="search-input" placeholder="Search administrators by name, email, or ID..." value="<?php echo htmlspecialchars($search); ?>">
                </form>
            </div>
        </div>
        ...
        <?php if (!empty($admin_list)): ?>
            <div class="admin-grid">
                <?php foreach ($admin_list as $index => $admin): ?>
                    <div class="admin-card" style="animation-delay: <?php echo ($index + 1) * 0.1; ?>s;">
                        ...
                        <div class="admin-details">
                            ...
                            <div class="admin-detail">
                                ...
                                <span><?php echo htmlspecialchars($admin['student_id'] ?? 'N/A'); ?></span>
                            </div>
                            <div class="admin-detail">
                                <i class="fas fa-book"></i>
                                <span><?php echo htmlspecialchars($admin['course'] ?? 'N/A'); ?></span>
                            </div>
                            <div class="admin-detail">
                                <i class="fas fa-layer-group"></i>
                                <span><?php echo htmlspecialchars($admin['classification'] ?? 'N/A'); ?></span>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <?php else: ?>
            <div class="controls-section">
                <div class="empty-state">
                    ...
                    <p><?php echo !empty($search) ? 'No administrators match your search criteria.' : 'No administrators found in the system.'; ?></p>
                </div>
            </div>
        <?php endif; ?>
    </div>
