...
// Prepare arrays for batch insertion (support both course_code and subject_code from the form)
...
try {
    ...
    // Redirect based on program (support BSAIS/BSA as well as legacy BSCS/BSIT)
    if (in_array($program, ['BSAIS', 'BSCS'], true)) {
        $redirect_page = 'curi_cs.php'; // BSAIS Curriculum
    } else {
        // BSA or BSIT go to BSA curriculum page
