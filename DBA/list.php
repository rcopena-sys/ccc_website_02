...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', sans-serif; }
        body { background: linear-gradient(135deg, #1d4ed8 0%, #3b82f6 50%, #1d4ed8 100%); }
        ...
        .profile-circle { width: 100px; height: 100px; border-radius: 50%; background-color: #3b82f6; margin-bottom: 30px; overflow: hidden; box-shadow: 0 4px 12px rgba(37,99,235,0.35); }
...
<div class="container">
    <div class="sidebar">
        <div class="profile-circle"><img src="bsa.png" alt="DCI Logo"></div>
        <div>DBA</div>
        <nav style="width: 100%; margin-top: 20px;">
            <a href="dashboard2.php" style="display: block; padding: 10px 0; color: white; text-decoration: none; border-radius: 8px; margin-bottom: 5px; background: #2563eb;">Dashboard</a>
            <div style="position: relative;">
                <button id="studentDropdownBtn" style="width: 100%; display: flex; justify-content: space-between; align-items: center; padding: 10px 0; background: #2563eb; color: white; border: none; border-radius: 8px; cursor: pointer;">
                    Student list
                    <span style="margin-left: 8px;">▼</span>
                </button>
                <div id="studentDropdownMenu" style="display: none; flex-direction: column; background: #eff6ff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.12); position: absolute; left: 0; top: 100%; width: 100%; z-index: 10;">
                    <a href="list.php" style="padding: 10px 16px; color: #1e3a8a; text-decoration: none; border-bottom: 1px solid #bfdbfe;">Student List</a>
                    <a href="stugra.php" style="padding: 10px 16px; color: #1e3a8a; text-decoration: none; border-bottom: 1px solid #bfdbfe;">Student Grade</a>
                    <a href="stucuri.php" style="padding: 10px 16px; color: #1e3a8a; text-decoration: none;">Student Curriculum</a>
                </div>
            </div>
            <a href="stucuri.php" style="display: block; padding: 10px 0; color: white; text-decoration: none; border-radius: 8px; margin: 5px 0; background: #2563eb;">Curriculum</a>
            <a href="stueval.php" style="display: block; padding: 10px 0; color: white; text-decoration: none; border-radius: 8px; margin: 5px 0; background: #2563eb; transition: background-color 0.3s;">Student Evaluation</a>
        </nav>
    ...
    <div class="content">
        ...
        // For DBA, always show only BSA and BSAIS programs
        $studentsWhere = ["st.programs IN ('BSA','BSAIS')"];
