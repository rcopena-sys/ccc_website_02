...
<head>
    ...
    <style>
        ...
        .profile-container::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #0f94a7, #1fbdd2, #6be3f3, #0f94a7);
        ...
        .profile-header {
            ...
            margin-bottom: 40px;
            padding-bottom: 30px;
            border-bottom: 2px solid rgba(31, 189, 210, 0.18);
            position: relative;
        }
        ...
        .profile-picture {
            ...
            object-fit: cover;
            margin-bottom: 20px;
            border: 6px solid #1fbdd2;
            box-shadow: 0 8px 32px rgba(15, 148, 167, 0.3), 0 0 0 3px rgba(255, 255, 255, 0.2);
            transition: transform 0.3s ease, box-shadow 0.3s ease;
        }
        
        .profile-picture:hover {
            transform: scale(1.05);
            box-shadow: 0 12px 40px rgba(15, 148, 167, 0.4), 0 0 0 3px rgba(255, 255, 255, 0.3);
        }
        ...
        .form-control {
            border: 2px solid rgba(31, 189, 210, 0.3);
            border-radius: 12px;
            padding: 12px 16px;
            font-size: 0.95rem;
        ...
        .form-control:focus {
            border-color: #1fbdd2;
            box-shadow: 0 0 0 4px rgba(31, 189, 210, 0.25);
            background: #ffffff;
            transform: translateY(-1px);
        }
        
        .btn-update {
            background: linear-gradient(135deg, #0f94a7 0%, #1fbdd2 100%);
            border: none;
            padding: 14px 32px;
            font-weight: 600;
            border-radius: 12px;
            ...
            font-size: 1rem;
            transition: all 0.3s ease;
            box-shadow: 0 4px 15px rgba(15, 148, 167, 0.3);
        }
        
        .btn-update:hover {
            background: linear-gradient(135deg, #1fbdd2 0%, #0f94a7 100%);
            transform: translateY(-2px);
            box-shadow: 0 8px 25px rgba(15, 148, 167, 0.4);
            color: white;
        }
        ...
        .password-section, .esign-section {
            ...
            border-radius: 16px;
            margin-top: 25px;
            border: 2px solid rgba(31, 189, 210, 0.2);
            box-shadow: 0 8px 25px rgba(15, 148, 167, 0.15);
        }
        ...
        .esign-preview {
            border: 2px dashed rgba(31, 189, 210, 0.3);
            border-radius: 12px;
            padding: 20px;
            text-align: center;
        ...
        .esign-preview.has-signature {
            border-color: rgba(31, 189, 210, 0.6);
            background: rgba(31, 189, 210, 0.05);
        }
        ...
        .input-group .btn {
            border: 2px solid rgba(31, 189, 210, 0.3);
            border-left: none;
            background: rgba(31, 189, 210, 0.12);
            color: #0f94a7;
            transition: all 0.3s ease;
        }
        
        .input-group .btn:hover {
            background: rgba(31, 189, 210, 0.25);
            color: #0f94a7;
        }
