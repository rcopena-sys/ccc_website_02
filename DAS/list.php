...
<div class="container">
    <div class="sidebar">
        <div class="profile-circle"><img src="as.png" alt="DCI Logo"></div>
        <div>DAS</div>
        <nav style="width: 100%; margin-top: 20px;">
            ...
            <div style="position: relative;">
                ...
                <div id="studentDropdownMenu" style="display: none; flex-direction: column; background: #eff6ff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); position: absolute; left: 0; top: 100%; width: 100%; z-index: 10;">
                    <a href="list.php" style="padding: 10px 16px; color: #1d4ed8; text-decoration: none; border-bottom: 1px solid #bfdbfe;">Student List</a>
                    <a href="stugra.php" style="padding: 10px 16px; color: #1d4ed8; text-decoration: none; border-bottom: 1px solid #bfdbfe;">Student Grade</a>
                    <a href="stucuri.php" style="padding: 10px 16px; color: #1d4ed8; text-decoration: none;">Student Curriculum</a>
                </div>
            </div>
    ...
    <div class="content">
        ...
        // Always restrict to Psychology program for DAS
        $studentsWhere = ["st.programs LIKE '%Psychology%'"];
