...
// Fetch curriculum data for Psychology
$curriculumData = [];
if ($selectedFiscalYear) {
    $sql = "SELECT * FROM curriculum WHERE program LIKE '%Psychology%' AND fiscal_year = ? ORDER BY year_semester, course_code";
...
<head>
  <meta charset="UTF-8">
  <title>PSYCHOLOGY Curriculum</title> <link rel="icon" type="image/x-icon" href="favicon.ico">
...
<body class="flex h-screen bg-gray-100">
    ...
    <div class="flex flex-col items-center">
        <img src="as.png" class="rounded-full border-4 border-white" alt="DAS Logo" />
        ...
        <div class="relative">
            <button id="studentDropdownBtn" class="w-full flex justify-between items-center py-2 px-4 rounded bg-blue-500 hover:bg-blue-700 focus:outline-none">
                Student
            ...
            <div id="studentDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
                ...
                <a href="student_grade.php" class="py-2 px-6 text-blue-700 hover:bg-blue-50 border-b border-blue-200">Student Grade</a>
                <a href="curi.php" class="py-2 px-6 text-blue-700 hover:bg-blue-50 last:rounded-b">Student Curriculum</a>
            </div>
        </div>
        <div class="relative">
            ...
            <div id="curriculumDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
                ...
                <a href="curi_it.php" class="py-2 px-6 text-blue-700 hover:bg-blue-50 last:rounded-b bg-blue-50">PSYCHOLOGY Curriculum</a>
            </div>
        </div>
    </nav>
    <script>
  ...
  <main class="flex-1 overflow-y-scroll p-8 space-y-12 main-content">
    ...
    <h2 class="text-3xl font-bold mb-4 no-print">PSYCHOLOGY Curriculum (Prospectus)</h2>
    ...
    <?php else: ?>
        <div class="mb-8 p-4 bg-blue-50 text-blue-800 rounded border border-blue-200 no-print">Showing curriculum for fiscal year <strong><?= htmlspecialchars($_GET['fiscal_year']) ?></strong>.</div>
    <?php endif; ?>
    ...
    <section class="space-y-10">
      ...
      <div class="mt-6">
        <h2 class="text-2xl font-bold">Bachelor of Science in Psychology</h2>
      </div>
    </header>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                ...
                <table id="table-sem1" class="w-full bg-white border">
                    <thead class="bg-[#1fbdd2] text-white">
                        <tr>
