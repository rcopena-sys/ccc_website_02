...
// The original code used $host and $database which were undefined.
$conn = new mysqli($servername, $username, $password, $dbname);

if ($conn->connect_error) {
    // Stop execution and display a clear connection error
...
/**
 * Checks if a student should be classified as irregular based on failed courses.
 * @param mysqli $conn The database connection.
 * @param string $studentId The student's ID.
 * @param int $currentYear The current academic year level.
 * @param int $currentSem The current academic semester.
 * @return bool True if the student has failed a course (final_grade >= 5.00 or NULL) or has irregular subjects.
 */
