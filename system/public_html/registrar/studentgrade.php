                ...
                <div class="table-responsive mx-auto" style="max-width: 98%;">
                    <table class="table table-hover mb-0 mx-auto text-center" style="background-color: white; width: 100%; max-width: 98%;">
                        ...
                        if ($search_performed) {
                            ...
                            $all_grades = $conn->query("SELECT * FROM grades_db ORDER BY student_id, course_code");
                            if ($all_grades) {
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-sm btn-outline-primary edit-grade" 
                                                ...
                                                title="Edit Grade"
                                                data-student-id="<?= htmlspecialchars($grade['student_id']) ?>"
                                                data-course-code="<?= htmlspecialchars($grade['course_code']) ?>"
                                                data-year="<?= htmlspecialchars($grade['year']) ?>"
                                                data-sem="<?= htmlspecialchars($grade['sem']) ?>"
                                                data-grade="<?= htmlspecialchars($grade['final_grade']) ?>">
