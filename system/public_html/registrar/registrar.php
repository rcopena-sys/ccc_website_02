...
<div class="container">
    <div class="sidebar">
        <div class="profile-circle"><img src="regs.jpg" alt=""></div>
        <div>Registrar</div>
        <nav style="width: 100%; margin-top: 20px;">
            <a href="dashboardr.php" style="display: block; padding: 10px 0; color: white; text-decoration: none; border-radius: 8px; margin-bottom: 5px; background: #6366f1;">Dashboard</a>
            <div style="position: relative;">
                ...
                <div id="studentDropdownMenu" style="display: none; flex-direction: column; background: #e0e7ff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); position: absolute; left: 0; top: 100%; width: 100%; z-index: 10;">
                    <a href="studentgrade.php" style="padding: 10px 16px; color: #3730a3; text-decoration: none; border-bottom: 1px solid #c7d2fe;">Student Grade</a>
                </div>
            </div>
    ...
    <div class="content">
        ...
        <div style="margin-bottom: 20px; display: flex; gap: 10px;">
            <a href="addsturegs.php" class="add-btn" style="display:inline-block; text-align:center; text-decoration:none;">+Add Student</a>
            <a href="Rbulk.php" class="bulk-update-btn" style="display:inline-block; text-align:center; text-decoration:none;">Bulk Student</a>
        </div>
