-- Active: 1743737407411@@127.0.0.1@3306@ccc_curriculum_evaluation
<?php
session_start();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($firstName) || empty($lastName) || empty($email) || empty($userType) || empty($password) || empty($studentnumber)) {
    ...
    if ($checkEmail->num_rows > 0) {
        ...
        $stmt->bind_param("sssss", $firstName, $lastName, $email, $password, $userType, $studentnumber);
