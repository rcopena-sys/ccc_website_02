...
<div class="container">
        ...
        <nav style="width: 100%; margin-top: 20px;">
            ...
            <div style="position: relative;">
                ...
                <div id="studentDropdownMenu" style="display: none; flex-direction: column; background: #e0e7ff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); position: absolute; left: 0; top: 100%; width: 100%; z-index: 10;">
                    ...
                    <a href="regularstu.php" style="padding: 10px 16px; color: #3730a3; text-decoration: none; border-bottom: 1px solid #c7d2fe; background: #c7d2fe;">Regular Students</a>
    ...
    <div class="content">
        ...
        // Base query - using only students_db, filtering for regular students only
        $studentsWhere = ["(LOWER(st.classification) = 'regular')"];
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo '<p>No regular students found.</p>';
        }
