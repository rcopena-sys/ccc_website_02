...
<body class="bg-blue-100 min-h-screen">
    <!-- Back Button -->
    <a href="dashboard2.php" class="fixed top-4 right-4 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full shadow-lg flex items-center">
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="form-section">
                <form action="../super_admin/view_feedback.php" method="POST" class="space-y-6">
