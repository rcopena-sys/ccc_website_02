...
// Load available fiscal years for BSIT from curriculum table
$availableFiscalYears = [];
$fySql = "SELECT DISTINCT fiscal_year FROM curriculum WHERE program = 'BSIT' AND fiscal_year IS NOT NULL AND fiscal_year <> '' ORDER BY fiscal_year DESC";
