...
?>
  ...
  <div class="col-md-3">
    ...
    <?php foreach ($labels as $ysKey => $label): 
        ...
        // Calculate total units for this semester from irregular_db only
        $semesterUnits = 0;
        $irregularUnits = 0;
        ...
        // Total units should only be irregular units (from irregular_db)
            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Page will reload automatically via other handlers
                    } else {
