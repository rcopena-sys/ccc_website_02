...
// Load available fiscal years for BSCS from curriculum table
$availableFiscalYears = [];
$fySql = "SELECT DISTINCT fiscal_year FROM curriculum WHERE program = 'BSCS' AND fiscal_year IS NOT NULL AND fiscal_year <> '' ORDER BY fiscal_year DESC";
    ...
    <nav class="space-y-4 mt-4">
        ...
        <div class="relative">
            ...
            <div id="curriculumDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
                <a href="curi_cs.php" class="py-2 px-6 text-blue-700 hover:bg-blue-100 border-b border-blue-100 first:rounded-t bg-blue-100">BSCS Curriculum</a>
                <a href="curi_it.php" class="py-2 px-6 text-blue-700 hover:bg-blue-100 last:rounded-b">BSIT Curriculum</a>
            </div>
        </div>
    </nav>
    <script>
    ...
    <section class="space-y-10">
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                ...
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem1" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
            ...
            <div class="w-full lg:w-1/2">
                ...
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem2" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">First Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem3" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
            ...
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">Second Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem4" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">First Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem5" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
            ...
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">Second Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem6" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">First Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem7" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
            ...
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">Second Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem8" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded mr-2">Edit</button>
