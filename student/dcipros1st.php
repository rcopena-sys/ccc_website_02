...
<body>
    ...
    <div class="main-content">
        ...
        <?php
        // Use existing connection from db_connect.php
        if (!isset($db) || empty($db)) {
            $db = (defined('APP_ENV') && APP_ENV === 'local')
                ? 'ccc_curriculum_evaluation'
                : 'u220649928_ccc_curriculum';
        }
...
foreach ($courses['1-2'] as $course) {
    echo '<!-- 1-2 Course: ' . htmlspecialchars($course['course_code']) . ' -->';
        ...
        echo '<h5 style="margin-top:0;color:#2c3e50;border-bottom:1px solid #dee2e6;padding-bottom:8px;margin-bottom:12px;">Academic Decision Summary - First Year BSIT</h5>';
