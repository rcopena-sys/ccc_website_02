...
<head>
    ...
    <title>BSCS Prospectus - Third Year</title> <link rel="icon" type="image/x-icon" href="favicon.ico">
...
<body>
    ...
    <div class="main-content">
        ...
        // Calculate total units for BSCS program - Third Year
        $totalProgramUnits = 0;
        $completedUnits = 0;
        ...
        try {
            ...
            // Get all third year courses from irregular_db (3-1)
            $whereClause = '';
...
foreach ($courses['3-2'] as $course) {
    echo '<!-- 3-2 Course: ' . htmlspecialchars($course['course_code']) . ' -->';
        ...
        <?php
        // Decision support for Year 3: compute average, failed/incomplete counts and show decision
        $numericSum = 0.0;
        $numericCount = 0;
        $failedCount = 0;
        $incompleteCount = 0;
        ...
        echo '<h5 style="margin-top:0;color:#2c3e50;border-bottom:1px solid #dee2e6;padding-bottom:8px;margin-bottom:12px;">Academic Decision Summary - Third Year BSCS</h5>';
