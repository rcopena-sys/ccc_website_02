<?php
// Use centralized, environment-aware database connection
...
<head>
    ...
    <title>Calendar of Events - Registrar</title>
    <style>
        * {
        ...
        .sidebar {
            ...
            box-shadow: 2px 0 16px rgba(37,99,235,0.25);
        }
...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <a href="calendar.php" class="nav-link active">Calendar of Events</a>
