...
<div class="container">
    <div class="sidebar">
        ...
        <nav style="width: 100%; margin-top: 20px;">
            ...
            <div style="position: relative;">
                ...
                <div id="studentDropdownMenu" style="display: none; flex-direction: column; background: #eff6ff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); position: absolute; left: 0; top: 100%; width: 100%; z-index: 10;">
    ...
    <div class="content">
        ...
        // Always restrict to Teacher Education programs only
        $studentsWhere[] = "st.programs IN ('Bachelor Of Elementary Education', 'Bachelor Of Secondary Education Major In English', 'Bachelor Of Secondary Education Major In Mathematics', 'Bachelor Of Secondary Education Major In Science')";
