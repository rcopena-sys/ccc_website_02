...
if (isset($_GET['success']) && $_GET['success'] == '1') {
    $successMessage = '<div class="mb-4 p-4 bg-blue-100 text-blue-800 rounded">Curriculum added successfully!</div>';
}
...
<body class="flex h-screen bg-blue-100">
    ...
    <nav class="space-y-4 mt-4">
        ...
        <div class="relative">
            ...
            <div id="curriculumDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
                <a href="curi_cs.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100 first:rounded-t">BSCS Curriculum</a>
                <a href="curi_it.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 last:rounded-b bg-blue-50">BSIT Curriculum</a>
            </div>
        </div>
    </nav>
    <script>
  ...
  <main class="flex-1 overflow-y-scroll p-8 space-y-12 main-content">
    ...
    <a href="add_curriculum.php" class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md no-print">
      + Add Curriculum
    </a>
