...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($student_info) {
            ...
            } elseif (strpos($program_field, 'BACHELOR OF SECONDARY EDUCATION MAJOR IN ENGLISH') !== false) {
                $program = 'Bachelor Of Secondary Education Major In English';
            } elseif (strpos($program_field, 'BACHELOR OF SECONDARY EDUCATION MAJOR IN MATHEMATICS') !== false) {
...
<head>
    ...
    <style>
        .grade-report { background: #fff; padding: 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(6, 95, 70, 0.15); border-top: 4px solid #059669; }
        .table th, .table td { vertical-align: middle !important; }
        .semester-title { background: #ecfdf5; padding: 10px; margin-top: 30px; border-radius: 5px; font-weight: bold; border-left: 4px solid #059669; color: #064e3b; }
        .btn-primary { background-color: #059669; border-color: #047857; }
        .btn-primary:hover { background-color: #047857; border-color: #065f46; }
        .btn-outline-primary { color: #059669; border-color: #059669; }
        .btn-outline-primary:hover { background-color: #059669; border-color: #059669; color: #ffffff; }
        .badge-primary, .bg-primary { background-color: #059669 !important; }
    </style>
</head>
