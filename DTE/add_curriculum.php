...
<body class="flex h-screen bg-blue-100">
    ...
    <aside class="w-64 bg-blue-600 text-white flex flex-col">
        ...
        <nav class="space-y-4 mt-4">
            <a href="dashboard2.php" class="block py-2 px-4 rounded bg-blue-500 hover:bg-blue-600">Dashboard</a>
            <div class="relative">
                ...
                <div id="studentDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
                    <a href="list.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100">Student List</a>
                    <a href="student_grade.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100">Student Grade</a>
                    <a href="curi.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50">Student Curriculum</a>
                </div>
            </div>
            <div class="relative">
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold mb-6">Add New Curriculum</h2>
                ...
                <a href="upload_curriculum_csv.php" class="inline-block bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">Add CSV File</a>
                            <div class="mb-6 p-4 bg-blue-50 text-blue-900 rounded">
    ...
    Download Sample CSV
            ...
            <form action="save_curriculum.php" method="POST" class="space-y-6">
                ...
                <button type="button" id="addSubject" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 flex items-center gap-2">
