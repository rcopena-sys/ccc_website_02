...
<head>
    ...
    <style>
        ...
        .profile-container::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #1e40af, #2563eb, #3b82f6, #1e40af);
        ...
        .profile-picture {
            ...
            box-shadow: 0 8px 32px rgba(37, 99, 235, 0.3), 0 0 0 3px rgba(255, 255, 255, 0.2);
            transition: transform 0.3s ease, box-shadow 0.3s ease;
        }
        
        .profile-picture:hover {
            transform: scale(1.05);
            box-shadow: 0 12px 40px rgba(37, 99, 235, 0.4), 0 0 0 3px rgba(255, 255, 255, 0.3);
        }
