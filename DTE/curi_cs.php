...
// Fetch curriculum data for BSCS
$curriculumData = [];
if ($selectedFiscalYear) {
    $sql = "SELECT * FROM curriculum WHERE program = 'BSCS' AND fiscal_year = ? ORDER BY year_semester, course_code";
...
<head>
    <meta charset="UTF-8">
    <title>BSCS Curriculum</title> <link rel="icon" type="image/x-icon" href="favicon.ico">
    ...
    <nav class="space-y-4 mt-4">
        ...
        <div class="relative">
            ...
            <div id="curriculumDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
                <a href="curi_cs.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100 first:rounded-t bg-blue-50">BSCS Curriculum</a>
                <a href="curi_it.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 last:rounded-b">BSIT Curriculum</a>
            </div>
        </div>
    </nav>
    <script>
...
<main class="flex-1 overflow-y-scroll p-8 space-y-12 main-content">
    ...
    <h2 class="text-3xl font-bold mb-4 no-print">BSCS Curriculum (Prospectus)</h2>
    ...
    <section class="space-y-10">
        ...
        <div class="flex justify-between items-start">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h2 class="text-lg">Bachelor Of Science In Computer Science</h2>
        ...
        <div class="mt-6">
            <h2 class="text-2xl font-bold">Bachelor of Science in Computer Science</h2>
        </div>
    </header>
