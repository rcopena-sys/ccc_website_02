...
$fySql = "SELECT DISTINCT fiscal_year FROM curriculum WHERE program = 'BSEME' AND fiscal_year IS NOT NULL AND fiscal_year <> '' ORDER BY fiscal_year DESC";
...
// Fetch curriculum data for Bachelor Of Secondary Education Major In English
$curriculumData = [];
if ($selectedFiscalYear) {
    $sql = "SELECT * FROM curriculum WHERE program = 'BSEME' AND fiscal_year = ? ORDER BY year_semester, course_code";
...
<head>
    <meta charset="UTF-8">
    <title>BSE Major In English Curriculum</title> <link rel="icon" type="image/x-icon" href="favicon.ico">
    ...
    <nav class="space-y-4 mt-4">
        ...
        <div class="relative">
            ...
            <div id="curriculumDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
				...
				<a href="bseme.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100 bg-blue-50">Bachelor Of Secondary Education Major In English</a>
...
<main class="flex-1 overflow-y-scroll p-8 space-y-12 main-content">
        ...
        <h2 class="text-3xl font-bold mb-4 no-print">BSE Major In English Curriculum (Prospectus)</h2>
    ...
    <section class="space-y-10">
        ...
        <div class="flex justify-between items-start">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h2 class="text-lg">Bachelor Of Secondary Education Major In English</h2>
        ...
        <div class="mt-6">
            <h2 class="text-2xl font-bold">Bachelor Of Secondary Education Major In English</h2>
        </div>
    </header>
