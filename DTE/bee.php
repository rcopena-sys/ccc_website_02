...
$fySql = "SELECT DISTINCT fiscal_year FROM curriculum WHERE program = 'BEE' AND fiscal_year IS NOT NULL AND fiscal_year <> '' ORDER BY fiscal_year DESC";
...
// Fetch curriculum data for Bachelor Of Elementary Education
$curriculumData = [];
if ($selectedFiscalYear) {
    $sql = "SELECT * FROM curriculum WHERE program = 'BEE' AND fiscal_year = ? ORDER BY year_semester, course_code";
...
<head>
    <meta charset="UTF-8">
    <title>Bachelor Of Elementary Education Curriculum</title> <link rel="icon" type="image/x-icon" href="favicon.ico">
    ...
    <style>
        ...
        <body class="flex h-screen bg-blue-100">

    <aside class="w-64 bg-blue-600 text-white p-6 flex flex-col no-print">
    <div class="flex flex-col items-center">
        <img src="dte.png" class="rounded-full border-4 border-white" alt="DCI Logo" />
    ...
    <nav class="space-y-4 mt-4">
        ...
        <div class="relative">
            ...
            <div id="studentDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
                ...
                <a href="student_grade.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100">Student Grade</a>
                <a href="curi.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 last:rounded-b">Student Curriculum</a>
            </div>
        </div>
        <div class="relative">
            ...
            <div id="curriculumDropdownMenu" class="hidden absolute left-0 w-full z-10 flex flex-col bg-white border border-blue-200 rounded shadow-lg mt-1">
				<a href="bee.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100 first:rounded-t bg-blue-50">Bachelor Of Elementary Education</a>
				<a href="bseme.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100">BSE Major In English</a>
				<a href="bsemm.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 border-b border-blue-100">BSE Major In Mathematics</a>
				<a href="bsems.php" class="py-2 px-6 text-blue-800 hover:bg-blue-50 last:rounded-b">BSE Major In Science</a>
            </div>
        </div>
    </nav>
    <script>
...
<main class="flex-1 overflow-y-scroll p-8 space-y-12 main-content">
    ...
    <h2 class="text-3xl font-bold mb-4 no-print">Bachelor Of Elementary Education Curriculum (Prospectus)</h2>
    ...
    <?php if (!isset($_GET['fiscal_year']) || !$_GET['fiscal_year']): ?>
        <div class="mb-8 p-4 bg-blue-100 text-blue-800 rounded no-print">Please select a fiscal year to view the curriculum.</div>
    <?php else: ?>
        <div class="mb-8 p-4 bg-blue-50 text-blue-900 rounded border border-blue-200 no-print">Showing curriculum for fiscal year <strong><?= htmlspecialchars($_GET['fiscal_year']) ?></strong>.</div>
    <?php endif; ?>
    ...
    <section class="space-y-10">
        ...
        <div class="flex justify-between items-start">
            <div class="flex items-center space-x-4">
                ...
                <div>
					...
					<h2 class="text-lg">Bachelor Of Elementary Education</h2>
        ...
        <div class="mt-6">
            <h2 class="text-2xl font-bold">Bachelor Of Elementary Education</h2>
        </div>
    </header>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                ...
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem1" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem1" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem1" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
            ...
            <div class="w-full lg:w-1/2">
                ...
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem2" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem2" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem2" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">First Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem3" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem3" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem3" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
            ...
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">Second Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem4" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem4" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem4" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">First Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem5" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem5" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem5" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
            ...
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">Second Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem6" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem6" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem6" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">First Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem7" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem7" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem7" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
            ...
            <div class="w-full lg:w-1/2">
                <h4 class="text-lg font-semibold mb-2">Second Semester</h4>
                <div class="mb-2 no-print">
                    <button id="edit-btn-sem8" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit</button>
                    <button id="save-btn-sem8" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 hidden">Save</button>
                    <button id="cancel-btn-sem8" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hidden">Cancel</button>
                </div>
...
<script>
    function makeTableEditable(tableId, editBtnId, saveBtnId, cancelBtnId) {
        const table = document.getElementById(tableId);
        const editBtn = document.getElementById(editBtnId);
        const saveBtn = document.getElementById(saveBtnId);
        const cancelBtn = document.getElementById(cancelBtnId);
        let original = [];
        let addBtn = document.getElementById(tableId + '-add-btn');
        if (!addBtn) {
            addBtn = document.createElement('button');
            addBtn.textContent = 'Add Subject';
            addBtn.className = 'bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded mt-2 hidden no-print';
            addBtn.id = tableId + '-add-btn';
            table.parentNode.insertBefore(addBtn, table.nextSibling); // Insert after the table
        }
        ...
        editBtn.addEventListener('click', () => {
            ...
            for (const row of table.tBodies[0].rows) {
                ...
                for (const cell of row.cells) {
                    ...
                    cell.innerHTML = `<input class='border w-full p-1' value='${cell.innerText.replace(/'/g, "&#39;")}' />`;
                }
                original.push(rowData);
            }
        ...
        cancelBtn.addEventListener('click', () => {
            for (let i = 0; i < table.tBodies[0].rows.length; i++) {
                for (let j = 0; j < table.tBodies[0].rows[i].cells.length; j++) {
                    table.tBodies[0].rows[i].cells[j].innerText = original[i][j];
                }
            }
            editBtn.classList.remove('hidden');
            saveBtn.classList.add('hidden');
        ...
        addBtn.addEventListener('click', function() {
            ...
            for (let i = 0; i < table.rows[0].cells.length; i++) {
                ...
                if (i === 1) {
                    cell.innerHTML = '<input type="text" class="w-full p-1 border rounded" placeholder="Course Title">';
                } else {
                    cell.innerHTML = '<input type="text" class="w-full p-1 border rounded">';
                }
            }
        });
    }

    // Attach editable functionality to all tables
    makeTableEditable('table-sem1','edit-btn-sem1','save-btn-sem1','cancel-btn-sem1');
    makeTableEditable('table-sem2','edit-btn-sem2','save-btn-sem2','cancel-btn-sem2');
    makeTableEditable('table-sem3','edit-btn-sem3','save-btn-sem3','cancel-btn-sem3');
    makeTableEditable('table-sem4','edit-btn-sem4','save-btn-sem4','cancel-btn-sem4');
    makeTableEditable('table-sem5','edit-btn-sem5','save-btn-sem5','cancel-btn-sem5');
    makeTableEditable('table-sem6','edit-btn-sem6','save-btn-sem6','cancel-btn-sem6');
    makeTableEditable('table-sem7','edit-btn-sem7','save-btn-sem7','cancel-btn-sem7');
    makeTableEditable('table-sem8','edit-btn-sem8','save-btn-sem8','cancel-btn-sem8');
</script>
